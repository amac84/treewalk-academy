...
const mockLiveOccurrences: LiveOccurrence[] = [
  {
    id: 'live-q2-planning',
    title: 'Q2 Planning Roundtable for Practice Leaders',
    description: 'Live PD session on planning priorities and firm operating cadence.',
    startAt: isoDaysFromNow(5),
    expectedMinutes: 60,
    status: 'scheduled',
    conversionStatus: 'scheduled',
    audience: 'everyone',
    createdByUserId: 'u-content-admin',
    presenterUserIds: ['u-instructor-1'],
...
export const mockInitialState: AppState = {
  ...
  completions: [],
  certificates: [],
  liveOccurrences: mockLiveOccurrences,
  liveOccurrenceAttendances: [
    {
      id: 'wa-1',
      occurrenceId: 'live-q2-planning',
      userId: 'u-learner-1',
      ...
      watchedSeconds: 4200,
      qualified: true,
      qualifiedAt: isoDaysAgo(1),
      qualificationReason: 'manual_marked',
    },
    {
      id: 'wa-2',
      occurrenceId: 'live-year-end-close',
      userId: 'u-learner-2',
      attendedAt: isoDaysAgo(370),
      source: 'replay',
      joinedAt: isoDaysAgo(370),
      lastActiveAt: isoDaysAgo(370),
      watchedSeconds: 3300,
      qualified: true,
      qualifiedAt: isoDaysAgo(370),
      qualificationReason: 'manual_marked',
    },
  ],
  liveRehearsal: {
    id: 'rehearsal-default',
    title: 'Presenter rehearsal stream',
    guidance:
      'Use this persistent rehearsal slot to validate camera, microphone, and slide framing before your first live occurrence.',
    muxLiveStreamId: '',
    muxPlaybackId: '',
    muxStreamKey: '',
